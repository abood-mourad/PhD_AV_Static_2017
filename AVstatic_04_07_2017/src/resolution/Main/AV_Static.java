...
public class AV_Static 
{
	...
	public static int num_offers;												//A global variable to save the original number of offers in the instance. 
	public static int num_requests;												//A global variable to save the original number of requests in the instance.
	...
	public static void main(String[] args) throws FileNotFoundException
	{
		...
		File f = new File("C:/Users/abood.mourad/workspace2/AVStatic_31_01_2017/Solutions/Match_Gen_Algo_V1/Result_NY_" + version + ".txt");
		//File f = new File("C:/Users/abood.mourad/workspace2/AVStatic_31_01_2017/Solutions/Match_Gen_Algo_V1/Result_BR_" + version + ".txt");
		//File f = new File("C:/Users/abood.mourad/workspace2/AVStatic_31_01_2017/Solutions/Match_Gen_Algo_V1/Result_BT_" + version + ".txt");
		//File f = new File("C:/Users/abood.mourad/workspace2/AVStatic_31_01_2017/Solutions/Match_Gen_Algo_V1/Result_BI_" + version + ".txt");
		...
		Data_Instance instance = Read_Instance("NYC", version);							//Read a Data_Instance object from a file.
		...
		instance.instance_id = "NYC_" + version;
		//instance.instance_id = "BR_" + version;
		//instance.instance_id = "BT_" + version;
		//instance.instance_id = "BI_" + version;
		num_offers = instance.offers.size();
		num_requests = instance.requests.size();
	...
	public static void Build_Instances(String city)
	{
		...
		for(int ni = 0 ; ni < 5 ; ni++)
		{
			...
			String line = null;
			String input_file = "C:/Users/abood.mourad/workspace2/AVstatic_31_01_2017/Data_Instances/" + city + "_ZoneXYs";
			String MPoutput_File = "C:/Users/abood.mourad/workspace2/AVstatic_31_01_2017/Data_Instances/" + city + "_MPs_" + ni;
			try 
			{
				...
				FileReader AVGwr = new FileReader("C:/Users/abood.mourad/workspace2/AVstatic_31_01_2017/Data_Instances/" + city + "_ZoneAVGs");
				BufferedReader AVGbr = new BufferedReader(AVGwr);
				FileWriter OFwr = new FileWriter("C:/Users/abood.mourad/workspace2/AVstatic_31_01_2017/Data_Instances/" + city + "_Offers_" + ni);
				FileWriter REwr = new FileWriter("C:/Users/abood.mourad/workspace2/AVstatic_31_01_2017/Data_Instances/" + city + "_Requests_" + ni);
	...
	public static void Build_NewYork_MPs()
	{
		...
		try 
		{
			FileWriter mp_writer = new FileWriter("C:/Users/abood.mourad/workspace2/AVstatic_31_01_2017/Data_Instances/NYC_MPs_0");
			...
			FileReader metro_reader = new FileReader("C:/Users/abood.mourad/workspace2/AVstatic_31_01_2017/Data_Instances/NYC_Metro.txt");
			...
			FileReader cbus_reader = new FileReader("C:/Users/abood.mourad/workspace2/AVstatic_31_01_2017/Data_Instances/NYC_Bus_Company.txt");
			...
			FileReader bronx_reader = new FileReader("C:/Users/abood.mourad/workspace2/AVstatic_31_01_2017/Data_Instances/NYC_Bus_Bronx.txt");
			...
			FileReader brooklyn_reader = new FileReader("C:/Users/abood.mourad/workspace2/AVstatic_31_01_2017/Data_Instances/NYC_Bus_Brooklyn.txt");
			...
			FileReader man_reader = new FileReader("C:/Users/abood.mourad/workspace2/AVstatic_31_01_2017/Data_Instances/NYC_Bus_Manhattan.txt");
			...
			FileReader queens_reader = new FileReader("C:/Users/abood.mourad/workspace2/AVstatic_31_01_2017/Data_Instances/NYC_Bus_Queens.txt");
			...
			FileReader staten_reader = new FileReader("C:/Users/abood.mourad/workspace2/AVstatic_31_01_2017/Data_Instances/NYC_Bus_Staten.txt");
	...
	public static void Build_NewYork_Trips()
	{
		...
		try {
			FileReader fr = new FileReader("C:/Users/abood.mourad/workspace2/AVstatic_31_01_2017/Data_Instances/Yellow03-01-2016.txt");
			BufferedReader br = new BufferedReader(fr);
			String line = null;
			while((line = br.readLine()) != null)
			{
			...
			FileWriter OFwr = new FileWriter("C:/Users/abood.mourad/workspace2/AVstatic_31_01_2017/Data_Instances/NYC_Offers_0");
			FileWriter REwr = new FileWriter("C:/Users/abood.mourad/workspace2/AVstatic_31_01_2017/Data_Instances/NYC_Requests_0");
			BufferedWriter OFbr = new BufferedWriter(OFwr);
			BufferedWriter REbr = new BufferedWriter(REwr);
			OFbr.write("ID \t\t Origin_X \t\t\t Origin_Y \t\t Destination_X \t\t Destination_Y \t\t E_time \t\t\t L_time \t\t\t Max_Duration \t\t\t Seats");
			OFbr.newLine();
			...
			int offer_counter = 1;
			int request_counter = 1;
			double participation_rate = 0.01;
	...
	public static Data_Instance Read_Instance(String city_instance, int version)
	{
		...
		try 
		{
			...
			FileReader MPfr = new FileReader("C:/Users/abood.mourad/workspace2/AVstatic_31_01_2017/Data_Instances/" + city_instance + "_MPs_" + version);
			...
			FileReader OFfr = new FileReader("C:/Users/abood.mourad/workspace2/AVstatic_31_01_2017/Data_Instances/" + city_instance + "_Offers_" + version);
			...
			FileReader REfr = new FileReader("C:/Users/abood.mourad/workspace2/AVstatic_31_01_2017/Data_Instances/" + city_instance + "_Requests_" + version);
			...
			for(int r = 0 ; r < instance.requests.size() ; r++)
			{
				...
				for(int mp = 0 ; mp < instance.meeting_points.size() ; mp++)						//For every meeting point.
				{
	...
	public static double Calculate_Distance(metHeuPoint p1, metHeuPoint p2)
	{
		...
		double dist = Math.sin(deg2rad(p1.y)) * Math.sin(deg2rad(p2.y)) + Math.cos(deg2rad(p1.y)) * Math.cos(deg2rad(p2.y)) * Math.cos(deg2rad(theta));
		dist = Math.acos(dist);
		dist = rad2deg(dist);
		dist = dist * 60 * 1.1515;
		dist = dist * 1.609344;
	...
	//A method that convert decimal degrees to radians.
	private static double deg2rad(double deg) 
	{
		return (deg * Math.PI / 180.0);
	}

	//A method that convert radians to decimal degrees.
	private static double rad2deg(double rad) 
	{
		return (rad * 180 / Math.PI);
	}
	
	//A method to calculate the CPU time in nano seconds.
